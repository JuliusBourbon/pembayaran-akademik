...
<body class="bg-slate-50 h-screen flex items-center justify-center">
    <div class="w-full max-w-sm bg-white p-6 rounded-xl shadow-lg">
        <h2 class="text-2xl font-bold text-center text-slate-900 mb-6">Portal Mahasiswa</h2>
        ...
        <form action="{{ url('/mahasiswa/login') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-slate-500 mt-1">*Gunakan No. Reg sebagai password jika belum lunas.</p>
            </div>
