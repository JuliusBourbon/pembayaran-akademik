...
<body class="bg-slate-100 min-h-screen font-mono text-slate-900" onload="window.print()">
    <div class="no-print fixed top-0 inset-x-0 bg-white border-b border-slate-200 p-4 shadow-sm z-50 flex justify-center gap-4">
        ...
        <a href="/dashboard" class="bg-slate-200 hover:bg-slate-300 text-slate-800 text-sm font-bold py-2 px-6 rounded shadow transition">
    ...
    <div class="struk-area mx-auto mt-24 mb-10 bg-white p-6 shadow-lg border border-slate-200 sm:rounded-none">
        ...
        <div class="flex flex-col border items-center">
            <h1 class="underline uppercase py-2 font-semibold text-lg">Bukti pembayaran registrasi ulang mahasiswa baru</h1>
            <div class="grid grid-cols-3 gap-2 border-y border-slate-800">
                <div class="text-xs space-y-1 p-3 border-r">
                ...
                <div class="text-xs space-y-1 border-l p-3">
                    <div class="w-full flex justify-center font-bold">
                        <h1>JUMLAH</h1>
                    </div>
                    <div class="flex h-full flex-col p-3">
