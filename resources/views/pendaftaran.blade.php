            ...
            <div class="relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl">
                <div class="bg-slate-50 px-4 py-5 sm:px-6 border-b border-slate-200 flex justify-between items-center">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500">Lengkapi data diri mahasiswa baru.</p>
                    </div>
                ...
                <form action="{{ route('mhs.store') }}" method="POST">
                    ...
                    <div class="px-4 py-5 sm:p-6 max-h-[70vh] overflow-y-auto">
                        ...
                        <div class="mb-6">
                            <h4 class="text-sm font-bold text-blue-600 uppercase tracking-wide mb-3">1. Data Pribadi</h4>
                            <div class="space-y-4">
                                <div>
                                ...
                                <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                                    <div>
                                        <label class="block text-sm font-medium leading-6 text-slate-900">No. HP Mahasiswa</label>
                                        <input type="number" name="telepon" placeholder="08..." required class="mt-1 block w-full rounded-md border-0 py-2 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium leading-6 text-slate-900">No. HP Orang Tua</label>
                                        <input type="number" name="tlp_ortu" placeholder="08..." required class="mt-1 block w-full rounded-md border-0 py-2 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium leading-6 text-slate-900">Alamat Domisili</label>
                        ...
                        <div>
                            <h4 class="text-sm font-bold text-blue-600 uppercase tracking-wide mb-3">2. Pilihan Studi</h4>
                            <div>
